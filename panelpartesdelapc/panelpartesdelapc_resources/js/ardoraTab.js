...
var timeInterval; $(document).ready(function() {paintOk();$("#buttonOk").mouseenter(function() {$(this).css("box-shadow", "0px 0px 0px rgba(50, 50, 50, 0.75)");removeOk();}).mouseleave(function() {$(this).css("box-shadow","4px 4px 4px rgba(50,50,50,0.5)");paintOk();}).mousedown(function() {if (typeGame!=99) {isCorrect();}});randomSort();timeInterval=setInterval("paintTab()",1000);
