...
function inicia(){
   ...
   menuLateral='';
   menuActividades='<h1></h1><a href=\"javascript:irA(0)\" title=\"Album de cuerpos geomtericos\">1 </a><a href=\"javascript:irA(1)\" title=\"Panel partes de la computadora\">2 </a>';
...
taboaContidos[0]=new act("Album de cuerpos geomtericos","Album de cuerpos geomtericos","","<object width='100%' height='420' type='text/html' data='albumcuerpos/albumcuerpos.htm'></object>",true,"",true,false,false);
taboaContidos[1]=new act("Panel partes de la computadora","Panel partes de la computadora","","<object width='100%' height='420' type='text/html' data='panelpartesdelapc/panelpartesdelapc.htm'></object>",true,"",true,false,false);
